...
export type AnalyticsResponse<
  ...
  Texpand = unknown,
> = Required<
  AnalyticsRecord<Tcancelled, Tdelivered, Tin_transit, Tpending, Tprocessing>
> &
  BaseSystemFields<Texpand>;
export type BannersResponse<Texpand = unknown> = Required<BannersRecord> &
  BaseSystemFields<Texpand>;
...
export type OrdersResponse<
  TproductOptions = unknown,
  Texpand = unknown,
> = Required<OrdersRecord<TproductOptions>> & BaseSystemFields<Texpand>;
export type ProductsResponse<Toptions = unknown, Texpand = unknown> = Required<
  ProductsRecord<Toptions>
> &
  BaseSystemFields<Texpand>;
export type ReviewCountResponse<
  Taverage_rating = unknown,
  Texpand = unknown,
> = Required<ReviewCountRecord<Taverage_rating>> & BaseSystemFields<Texpand>;
export type ReviewsResponse<Texpand = unknown> = Required<ReviewsRecord> &
  BaseSystemFields<Texpand>;
export type ShippingInfoResponse<Texpand = unknown> =
  Required<ShippingInfoRecord> & BaseSystemFields<Texpand>;
